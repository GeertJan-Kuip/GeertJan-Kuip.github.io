...
Several general methods return the name of the Symbol or are otherwise related to the name field. These methods do not return a String but a Name object. name lives in package `com.sun.tools.javac.util` and is not exported. namely:

...
#### Kind-related methods

There is an interface ElementKind in `javax.lang.model.element` and there is a class named Kinds in `com.sun.tools.javac.code`. As the package names suggest, the latter is more obscure and less friendly to use, being part of a non-exported package. 

ElementKind contains the following values:

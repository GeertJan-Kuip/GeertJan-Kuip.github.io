...
Note: you can do the editing of the manifest file as well in the configuration of the maven-jar-plugin, the result will be the same. This is the code for that:
...
```
	<plugin>
		...
		<configuration>
			<archive>
				<manifest>
					<mainClass>com.geertjankuip.test.MyClass</mainClass>
				</manifest>
			</archive>					
		</configuration>
	</plugin>
